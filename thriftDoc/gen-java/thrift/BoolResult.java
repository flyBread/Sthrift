...
public class BoolResult implements org.apache.thrift.TBase<BoolResult, BoolResult._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BoolResult");
  ...
  static {
    schemes.put(StandardScheme.class, new BoolResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BoolResultTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.RESULT,_Fields.CODE,_Fields.MSG};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BoolResult.class, metaDataMap);
  }
  ...
  public BoolResult setResult(boolean result) {
    this.result = result;
    setResultIsSet(true);
    return this;
  }
  ...
  public BoolResult setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public BoolResult setMsg(String msg) {
    this.msg = msg;
    return this;
  }
  ...
  private static class BoolResultStandardSchemeFactory implements SchemeFactory {
    public BoolResultStandardScheme getScheme() {
      return new BoolResultStandardScheme();
    }
  }

  private static class BoolResultStandardScheme extends StandardScheme<BoolResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BoolResult struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BoolResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BoolResultTupleSchemeFactory implements SchemeFactory {
    public BoolResultTupleScheme getScheme() {
      return new BoolResultTupleScheme();
    }
  }
